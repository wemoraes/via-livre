...
export default function StudentHeader({ name, avatarUrl }: Props) {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        <Link href="/aluno" className="text-base font-bold tracking-tight" style={{ color: "var(--vl-text-1)" }}>
          ViaLivre
        </Link>
        ...
        <div className="relative" ref={wrapRef}>
          ...
          >
            {avatarUrl ? (
              <Image src={avatarUrl} alt={name} width={32} height={32} className="rounded-full object-cover w-8 h-8" />
            ) : (
              <span
